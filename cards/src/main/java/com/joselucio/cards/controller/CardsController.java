package com.joselucio.cards.controller;

import com.joselucio.cards.constant.CardsConstants;
import com.joselucio.cards.dtos.CardsDto;
import com.joselucio.cards.dtos.ErrorResponseDto;
import com.joselucio.cards.dtos.ResponseDto;
...
@Tag(
        name = "CRUD REST APIs for Cards in Project",
        description = "CRUD REST APIs in Project to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
@AllArgsConstructor
@Validated
...
public class CardsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside Project"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CardsDto> fetchCardDetails(@RequestParam @Pattern
